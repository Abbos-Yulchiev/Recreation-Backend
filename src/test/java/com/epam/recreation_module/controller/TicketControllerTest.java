...
class TicketControllerTest {
    ...
    void testGetAllByEventId() throws Exception {
        when(this.ticketService.getAllByEventId((Long) ArgumentMatchers.any())).thenReturn(new ResponseEntity<>(HttpStatus.CONTINUE));
    ...
    void testNewTickets() throws Exception {
        when(this.ticketService.newTickets((TicketDTO) ArgumentMatchers.any())).thenReturn(new ResponseEntity<>(HttpStatus.CONTINUE));
    ...
    void testEditTickets() throws Exception {
        when(this.ticketService.editTickets((TicketDTO) ArgumentMatchers.any())).thenReturn(new ResponseEntity<>(HttpStatus.CONTINUE));
    ...
    void testGetUnsoldTickets() throws Exception {
        when(this.ticketService.getUnSoldTickets((Long) ArgumentMatchers.any())).thenReturn(new ResponseEntity<>(HttpStatus.CONTINUE));
