...
public class EventController {
     ...
     * @return <em>HTTP</em> response with success or failure message
     */
     ...
     *
     * @param eventId  Event ID which wanted to edit
     * @param status Object to edit an Event
     * @return <em>HTTP</em> response with success or failure message
     */

    @ApiOperation(value = "Edit an Event by id")
    @PutMapping(value = "/editEventStatus/{eventId}")
    public ResponseEntity<?> editEventStatus(@ApiParam("Event ID") @PathVariable Long eventId,
                                       @ApiParam("EventDTO object") @RequestBody String status) {
        return eventService.editEventStatus(eventId, status);
    }
     ...
     * @return <em>HTTP</em> response with Event ID
     */
    @ApiIgnore
