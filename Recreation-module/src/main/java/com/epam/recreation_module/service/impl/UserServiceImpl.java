...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<?> deleteUser(Long id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse("User Successfully deleted!", true));
    }
    ...
    public ResponseEntity<?> activateUser(Long id) {
        ...
        userRepository.save(user);
        return ResponseEntity.status(HttpStatus.ACCEPTED).body(new ApiResponse("User activated!", true));
    }
