...
public class PhotoServiceImpl implements PhotoService {
    ...
    @Override
    public ApiResponse addPhoto(Long recreationId, MultipartFile file) {
        ...
        if (file != null) {
            try {
                ...
                return new ApiResponse("Invalid file type", false);
            }
        }
    ...
    public ApiResponse editPhoto(Long photoId, Long recreationId, MultipartFile file) {
        ...
        if (optionalPhoto.isPresent()) {
            try {
                ...
                Long attachmentContentId = attachment.getId();
